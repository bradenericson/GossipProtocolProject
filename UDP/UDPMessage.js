...
module.exports = function() {
    ...
    self.createForGetResponse = function(datagramPacket_in) {
        if (typeof datagramPacket_in != "undefined") {
            ...
            var partNumberChunk = datagramPacket_in.splice(0, 4);

            //console.log("partNumberChunk: ", partNumberChunk);
            //console.log("partNumberChunk converted: ", convertByteArraytoInteger(partNumberChunk));

            self.partNumber = convertByteArraytoInteger(partNumberChunk);

            //console.log("self.partNumber in createForGetResponse is: ", self.partNumber);
    ...
    self.createUdpPacket = function() {
        ...
        if(self.hasOwnProperty("partNumber")){
            ...
            var tempPartNumber = convertIntegerToByteArray(self.partNumber);
            //console.log("partNumber: ", self.partNumber);
            //console.log("tempPartNumber byteArray: ", tempPartNumber);
            bufferArray.push(new Buffer(tempPartNumber));
...
function convertIntegerToByteArray(integer) {
    ...
    //console.log("Received integer to convert to byteArray: ", integer);
    ...
    //console.log("Generated byteArray for integer is: ", byteArray);
    return byteArray;
